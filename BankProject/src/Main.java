public class Main {
    public static void main(String[] args) {
        ...
        account3.getAccountDetails();
        account3.login(client3, "changeme");
        account3.changePassword(client3, "changeme", "password");
        bank2.operation(account3, 510);
        account3.login(client3, "password");
        bank2.operation(account3, 510);
        System.out.println(bank2.totalBalance());

        System.out.println("----ACCOUNTABLES----");
        Salary salary1 = new Salary (15000);
        Salary salary2 = new Salary (20000);
        Salary salary3 = new Salary (30000);
        Subscrictions sub1 = new Subscrictions(50);
        Subscrictions sub2 = new Subscrictions(100);
        Subscrictions sub3 = new Subscrictions(1500);
